...
import com.example.myfirstapplication.MovieDetailResultActivity
...
class LatestMovieService : Service() {
    ...
    private fun createNotification(): Notification {
        ...
        val builder: Notification.Builder = if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.
    ...
    private fun getData() {
        try {
            ...
            val notifyIntent = Intent(this, MovieDetailResultActivity::class.java).apply {
                //Naglašavamo da je riječ o posebnoj aktivnosti koja samo služi za prikaz podatak a notifikacije
